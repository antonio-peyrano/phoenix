             ...
             if($Registro)
                {
                    ...
                    echo'               <tr class= "dgHeader"><td alignt= "left" colspan= 2"><a href="#" onclick="cargar(\'./php/frontend/consulplan/conPrograma.php\',\'?idestope='.$idEstOpe.'&idobjope='.$idObjOpe.'&idobjest='.$idObjEst.'\',\'escritorio\');"><img align= "right" src= "./img/grids/volver.png" width= "25" height= "25" alt= "Volver" id= "btnVolver"/></a></td></tr>
                            </table></div><br>';
                    }
            /*
    ...
    function constructor($dataset)
        {        
            ...
            echo'       <center>';
                        ...
                        loadInfo($idPrograma,'Información del Programa');
                        dgCabeceras($dataset,'Actividades');//Funcion para crear la cabecera de columnas de datos.
