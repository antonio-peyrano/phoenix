 ...
 */
    ...
    $sufijo= "eop_"; //Variable de control de sufijo de identificadores.
    $Inicio = 0;
    $Pagina = 0;
    $DisplayRow = 10;
    ...
    if(isset($_GET['nomestope']))
        {
            /*
             * Si el archivo ha sido llamado como una referencia con parametros.
             */
            $condicionales= 'EstOpe LIKE \'%'.$_GET['nomestope'].'%\'';
            }

    if(isset($_GET['estopenomenclatura']))
        {
            /*
             * Si el archivo ha sido llamado como una referencia con parametros.
             */
            ...
            $condicionales= $condicionales.'Nomenclatura LIKE \'%'.$_GET['estopenomenclatura'].'%\'';
            }

    if(isset($_GET['estopeperiodo']))
        {
            /*
             * Si el archivo ha sido llamado como una referencia con parametros.
             */
            ...
            $condicionales= $condicionales.'Periodo LIKE \'%'.$_GET['estopeperiodo'].'%\'';
            }
    ...
    if($condicionales=="")
        {
            ...
            $consulta= "SELECT idEstOpe, Nomenclatura, EstOpe, Periodo, Status FROM catEstOpe WHERE Status=0"." limit ".$Inicio.",".$DisplayRow; //Se establece el modelo de consulta de datos.
            }  
    else 
        {
            //En caso de contar con el criterio de filtrado.
            $consulta= "SELECT idEstOpe, Nomenclatura, EstOpe, Periodo, Status FROM catEstOpe WHERE Status=0 AND " .$condicionales." limit ".$Inicio.",".$DisplayRow; //Se establece el modelo de consulta de datos.
            }  
    ...
    function constructor($dataset, $sufijo)
        {        
            ...
            $objGrid = new myGrid($dataset, 'Catalogo de Estrategias Operativas', $sufijo, 'idEstOpe');
