 ...
 */
    ...
    $Registro = @mysql_fetch_array(cargarRegistro($parametro),MYSQLI_ASSOC);//Llamada a la funciÃ³n de carga de registro de usuario.
    ...
    function constructor()
        {
            ...
            echo '                              <option value=-1>Seleccione</option>';
                                ...
                                $RegEntidades = @mysql_fetch_array($subconsulta,MYSQLI_ASSOC);
