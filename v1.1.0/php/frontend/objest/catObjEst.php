 ...
 */
    ...
    if(isset($_GET['nomobjest']))
        {
             ...
             */
            $condicionales= 'ObjEst LIKE \'%'.$_GET['nomobjest'].'%\'';
            }

    if(isset($_GET['objestnomenclatura']))
        {
            /*
             * Si el archivo ha sido llamado como una referencia con parametros.
             */
            ...
            $condicionales= $condicionales.'Nomenclatura LIKE \'%'.$_GET['objestnomenclatura'].'%\'';
            }

    if(isset($_GET['objestperiodo']))
        {
            /*
             * Si el archivo ha sido llamado como una referencia con parametros.
             */
            ...
            $condicionales= $condicionales.'Periodo LIKE \'%'.$_GET['objestperiodo'].'%\'';
            }
    ...
    function constructor($dataset,$sufijo)
        {        
            ...
            $objGrid = new myGrid($dataset, 'Catalogo de Objetivos Estrategicos', $sufijo, 'idObjEst');
