 ...
 */
    ...
    $consulta= 'UPDATE opUsrTemp SET Status=1 where idUsrtmp='.$parametro; //Se establece el modelo de consulta de datos.
    $dataset = $objConexion -> conectar($consulta); //Se ejecuta la consulta.
        
    include_once($_SERVER['DOCUMENT_ROOT']."/micrositio/php/frontend/usraltas/busSolAltUsr.php");
    ?>