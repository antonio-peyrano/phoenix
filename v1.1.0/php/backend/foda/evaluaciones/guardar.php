 ...
 */
    ...
    if(isset($_GET['id'])&&isset($_GET['folio'])&&isset($_GET['idcedula'])&&isset($_GET['idempleado'])&&isset($_GET['fecha'])&&isset($_GET['status']))
        {
            /*
            ...
            if($idEvaluacion != null)
                {
                     ...
                     */
                    $consulta = 'UPDATE opEvaluaciones SET Folio=\''.$Folio.'\', Fecha=\''.$Fecha.'\', idCedula=\''.$idCedula.'\', idEmpleado=\''.$idEmpleado.'\', Status=\''.$Status.'\' WHERE idEvaluacion='.$idEvaluacion; //Se establece el modelo de consulta de datos.
                    }
            else
                {
                    /*
                     ...
                     */
                    $consulta = 'INSERT INTO opEvaluaciones (Folio, idEmpleado, idCedula, Fecha) VALUES ('.'\''.$Folio.'\',\''.$idEmpleado.'\',\''.$idCedula.'\',\''.$Fecha.'\')'; //Se establece el modelo de consulta de datos.
                    }
