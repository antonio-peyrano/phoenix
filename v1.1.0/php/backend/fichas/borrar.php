 ...
 */
    ...
    $consulta= 'UPDATE opFichasProcesos SET Status=1 where idFicha='.$parametro; //Se establece el modelo de consulta de datos.
    $dataset = $objConexion -> conectar($consulta); //Se ejecuta la consulta.
    
    $consulta= 'UPDATE relIndFicha SET Status=1 where idFicha='.$parametro; //Se establece el modelo de consulta de datos.
    $dataset = $objConexion -> conectar($consulta); //Se ejecuta la consulta.
