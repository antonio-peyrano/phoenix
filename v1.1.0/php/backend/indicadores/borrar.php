    ...
    if($listado == '0')
        {
             ...
             */
            $consulta= 'UPDATE catIndicadores SET Status=1 where idIndicador='.$parametro; //Se establece el modelo de consulta de datos.
            $dataset = $objConexion -> conectar($consulta); //Se ejecuta la consulta.
    
            /*
             * Con las relaciones de las entidades.
             */
            $consulta= 'UPDATE relIndPro SET Status=1 where idIndicador='.$parametro; //Se establece el modelo de consulta de datos.
            $dataset = $objConexion -> conectar($consulta); //Se ejecuta la consulta.
            }
    else
        {
             ...
             */
            $consulta= 'UPDATE relIndPro SET Status=1 where idRelIndPro='.$parametro; //Se establece el modelo de consulta de datos.
            $dataset = $objConexion -> conectar($consulta); //Se ejecuta la consulta.
            }
        
    include_once($_SERVER['DOCUMENT_ROOT']."/phoenix/php/frontend/indicadores/busIndicadores.php");
    ?>