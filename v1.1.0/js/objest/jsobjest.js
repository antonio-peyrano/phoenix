    	...
    	if(e.target.id.substring(0,10) == "oes_delete")
    		{
    			...
    			if(respuesta)
    				{
    					//Si el usuario confirma su solicitud de borrar el registro seleccionado.
    					cargar('./php/backend/objest/borrar.php','?id='+e.target.id.substring(11),'escritorio');
    					} 		
    			}
    });                 
});
    	...
    	if(e.target.id.substring(0,7) == "oes_add")
    		{
    			...
    			cargar('./php/frontend/objest/opObjEst.php','?id=-1&view=0','escritorio');
    			}
    });                 
});
    	...
    	if(e.target.id.substring(0,14) == "oes_visualizar")
    		{
    			...
    			cargar('./php/frontend/objest/opObjEst.php','?id='+e.target.id.substring(15)+'&view=1','escritorio');
    			}
    });                 
});
    	...
    	if(e.target.id.substring(0,8) == "oes_edit")
    		{
    			...
    			cargar('./php/frontend/objest/opObjEst.php','?id='+e.target.id.substring(9)+'&view=0','escritorio');
    			}
    });                 
});
