 ...
 *
 * REBOOT_Script: Estos bloques de codigo T-SQL solo deben ser ejecutados cuando la base de datos
 * necesite ser purgada para un inicio en limpio como si se instalara el sistema por primera vez.
 * Antes de ejecutar la limpieza sobre la base de datos, ejecute las operaciones de respaldo necesarias
 * a fin de savalguardar su información.
 *
 */
 
/*
 * Bloque de instrucciones para el borrado de los registros almacenados
 * en las entidades del sistema.
 */
DELETE FROM catModulos;
DELETE FROM opRelPerUsr;
DELETE FROM catUsuarios;
DELETE FROM catEstOpe;
DELETE FROM catIndicadores;
DELETE FROM catProcesos;
DELETE FROM catTEntidades;
DELETE FROM catEntidades;
DELETE FROM opProgramas;
DELETE FROM relEntPro;
DELETE FROM relIndPro;
DELETE FROM catIndicadores;
DELETE FROM opActividades;
DELETE FROM opEjecuciones;
DELETE FROM opProgAct;
DELETE FROM opEjecAct;
DELETE FROM opProgPro;
DELETE FROM opEjecPro;
DELETE FROM opProgEst;
DELETE FROM opEjecEst;
DELETE FROM catUnidades;
DELETE FROM catNiveles;
DELETE FROM opUsrTemp;
DELETE FROM opClientes;
DELETE FROM catColonias;
DELETE FROM opAtenciones;
DELETE FROM catObjEst;
DELETE FROM catObjOpe;
DELETE FROM opEmpleados;
DELETE FROM catPuestos;
DELETE FROM relEntPuesto;
DELETE FROM relProgPro;
DELETE FROM opProgOE;
DELETE FROM opEjecOE;
DELETE FROM opEjecOO;
DELETE FROM opProgOO;
DELETE FROM opEficAct;
DELETE FROM opEficPro;
DELETE FROM opEficEst;
DELETE FROM opEficOE;
DELETE FROM opEficOO;
DELETE FROM catConfiguraciones;
DELETE FROM opEvidencias;
DELETE FROM catVehiculos;
DELETE FROM opProgGas;
DELETE FROM opEjecGas;
DELETE FROM opEficGas;
DELETE FROM opMovGas;
DELETE FROM opFichasProcesos;
DELETE FROM relIndFicha;
DELETE FROM relUsrEmp;
DELETE FROM opFactores;
DELETE FROM opEscalas;
DELETE FROM opEvaluaciones;
DELETE FROM opCedulas;
DELETE FROM opResParFoda;

/*
 * Bloque de instrucciones de reset para el campo identificador
 * de las entidades del sistema.
 */
ALTER TABLE catModulos AUTO_INCREMENT = 1;
ALTER TABLE opRelPerUsr AUTO_INCREMENT = 1;
ALTER TABLE catUsuarios AUTO_INCREMENT = 1;
ALTER TABLE catEstOpe AUTO_INCREMENT = 1;
ALTER TABLE catIndicadores AUTO_INCREMENT = 1;
ALTER TABLE catProcesos AUTO_INCREMENT = 1;
ALTER TABLE catTEntidades AUTO_INCREMENT = 1;
ALTER TABLE catEntidades AUTO_INCREMENT = 1;
ALTER TABLE opProgramas AUTO_INCREMENT = 1;
ALTER TABLE relEntPro AUTO_INCREMENT = 1;
ALTER TABLE relIndPro AUTO_INCREMENT = 1;
ALTER TABLE catIndicadores AUTO_INCREMENT = 1;
ALTER TABLE opActividades AUTO_INCREMENT = 1;
ALTER TABLE opEjecuciones AUTO_INCREMENT = 1;
ALTER TABLE opProgAct AUTO_INCREMENT = 1;
ALTER TABLE opEjecAct AUTO_INCREMENT = 1;
ALTER TABLE opProgPro AUTO_INCREMENT = 1;
ALTER TABLE opEjecPro AUTO_INCREMENT = 1;
ALTER TABLE opProgEst AUTO_INCREMENT = 1;
ALTER TABLE opEjecEst AUTO_INCREMENT = 1;
ALTER TABLE catUnidades AUTO_INCREMENT = 1;
ALTER TABLE catNiveles AUTO_INCREMENT = 1;
ALTER TABLE opUsrTemp AUTO_INCREMENT = 1;
ALTER TABLE opClientes AUTO_INCREMENT = 1;
ALTER TABLE catColonias AUTO_INCREMENT = 1;
ALTER TABLE opAtenciones AUTO_INCREMENT = 1;
ALTER TABLE catObjEst AUTO_INCREMENT = 1;
ALTER TABLE catObjOpe AUTO_INCREMENT = 1;
ALTER TABLE opEmpleados AUTO_INCREMENT = 1;
ALTER TABLE catPuestos AUTO_INCREMENT = 1;
ALTER TABLE relEntPuesto AUTO_INCREMENT = 1;
ALTER TABLE relProgPro AUTO_INCREMENT = 1;
ALTER TABLE opProgOE AUTO_INCREMENT = 1;
ALTER TABLE opEjecOE AUTO_INCREMENT = 1;
ALTER TABLE opEjecOO AUTO_INCREMENT = 1;
ALTER TABLE opProgOO AUTO_INCREMENT = 1;
ALTER TABLE opEficAct AUTO_INCREMENT = 1;
ALTER TABLE opEficPro AUTO_INCREMENT = 1;
ALTER TABLE opEficEst AUTO_INCREMENT = 1;
ALTER TABLE opEficOE AUTO_INCREMENT = 1;
ALTER TABLE opEficOO AUTO_INCREMENT = 1;
ALTER TABLE catConfiguraciones AUTO_INCREMENT = 1;
ALTER TABLE opEvidencias AUTO_INCREMENT = 1;
ALTER TABLE catVehiculos AUTO_INCREMENT = 1;
ALTER TABLE opProgGas AUTO_INCREMENT = 1;
ALTER TABLE opEjecGas AUTO_INCREMENT = 1;
ALTER TABLE opEficGas AUTO_INCREMENT = 1;
ALTER TABLE opMovGas AUTO_INCREMENT = 1;
ALTER TABLE opFichasProcesos AUTO_INCREMENT = 1;
ALTER TABLE relIndFicha AUTO_INCREMENT = 1;
ALTER TABLE relUsrEmp AUTO_INCREMENT = 1;
ALTER TABLE opFactores AUTO_INCREMENT = 1;
ALTER TABLE opEscalas AUTO_INCREMENT = 1;
ALTER TABLE opEvaluaciones AUTO_INCREMENT = 1;
ALTER TABLE opCedulas AUTO_INCREMENT = 1;
ALTER TABLE opResParFoda AUTO_INCREMENT = 1;

/*
 * Bloque de instrucciones para la reconstruccion de los datos necesarios
