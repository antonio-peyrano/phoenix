		            			...
		            			if(result)
		            				{
		            					...
		            					cargar('./php/backend/entidades/borrar.php','?id='+e.target.id.substring(11),'sandbox');
		            					}			            					
		            			}
	            		});		
    			}
    	...
    	if(e.target.id.substring(0,7) == "ent_add")
    		{
    			...
    			cargar('./php/frontend/entidades/opEntidades.php','?id=-1&view=0','sandbox');
    			}
    });                 
});
    	...
    	if(e.target.id.substring(0,14) == "ent_visualizar")
    		{
    			...
    			cargar('./php/frontend/entidades/opEntidades.php','?id='+e.target.id.substring(15)+'&view=1','sandbox');
    			}
    });                 
});
    	...
    	if(e.target.id.substring(0,8) == "ent_edit")
    		{
    			...
    			cargar('./php/frontend/entidades/opEntidades.php','?id='+e.target.id.substring(9)+'&view=0','sandbox');
    			}
    });                 
});
