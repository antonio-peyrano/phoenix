...
function habObjEst(){
	...
	document.getElementById('oes_Guardar').style.display="block";
	document.getElementById('oes_Borrar').style.display="none";
	document.getElementById('oes_Editar').style.display="none";
		...
		$(document).ready(function()
			{
	    		$("div").click(function(e)
	    			{
	    		     	e.stopPropagation();
	    		        if(e.target.id == "oes_Volver")
	    		        	{
	    		            	//En caso de coincidir el id con la accion volver.
	    		        		cargar('./php/frontend/objest/busObjEst.php','','sandbox');
	    		            	}
	    				});                 
				});
	    				            	...
	    				            	callback: function (result)
	    				            		{
	    				            			if(result)
	    				            				{
	    				            					//EL USUARIO DECIDE BORRAR EL REGISTRO.
	    				            					cargar('./php/backend/objest/borrar.php','?id='+document.getElementById('idObjEst').value.toString(),'sandbox');
	    				            					}			            					
	    				            			}
	    			            		});
	    			    		}
