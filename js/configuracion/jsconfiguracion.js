    	...
    	if(e.target.id.substring(0,10) == "cnf_delete")
    		{
    			...
    			if(respuesta)
    				{
    					//Si el usuario confirma su solicitud de borrar el registro seleccionado.
    					cargar('./php/backend/configuracion/borrar.php','?id='+e.target.id.substring(11),'escritorio');
    					} 		
    			}
    });                 
});
    	...
    	if(e.target.id.substring(0,7) == "cnf_add")
    		{
    			...
    			cargar('./php/frontend/configuracion/opConfiguraciones.php','?id=-1&view=0','escritorio');
    			}
    });                 
});
    	...
    	if(e.target.id.substring(0,14) == "cnf_visualizar")
    		{
    			...
    			cargar('./php/frontend/configuracion/opConfiguraciones.php','?id='+e.target.id.substring(15)+'&view=1','escritorio');
    			}
    });                 
});
    	...
    	if(e.target.id.substring(0,8) == "cnf_edit")
    		{
    			...
    			cargar('./php/frontend/configuracion/opConfiguraciones.php','?id='+e.target.id.substring(9)+'&view=0','escritorio');
    			}
    });                 
});
