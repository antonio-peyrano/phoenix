    ...
    if($condicionales=="")
        {
            ...
            $consulta= "SELECT idUnidad, Nomenclatura, Unidad, Status FROM catUnidades WHERE Status=0"; //Se establece el modelo de consulta de datos.
            }  
    else 
        {
            //En caso de contar con el criterio de filtrado.
            $consulta= "SELECT idUnidad, Nomenclatura, Unidad, Status FROM catUnidades WHERE Status=0 AND " .$condicionales; //Se establece el modelo de consulta de datos.
            }  
