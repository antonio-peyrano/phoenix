 ...
 */
    ...
    $sufijo= "uni_"; //Variable de control de sufijo de identificadores.
    $Inicio = 0;
    $Pagina = 0;
    $DisplayRow = 10;
    ...
    if(isset($_GET['nomunidad']))
        {
            /*
             * Si el archivo ha sido llamado como una referencia con parametros.
             */
            $condicionales= 'Unidad LIKE \'%'.$_GET['nomunidad'].'%\'';
            }

    if(isset($_GET['uninomenclatura']))
        {
            /*
             * Si el archivo ha sido llamado como una referencia con parametros.
             */
            ...
            $condicionales= $condicionales.'Nomenclatura LIKE \'%'.$_GET['uninomenclatura'].'%\'';
            }
    ...
    if($condicionales=="")
        {
            ...
            $consulta= "SELECT idUnidad, Nomenclatura, Unidad, Status FROM catUnidades WHERE Status=0"." limit ".$Inicio.",".$DisplayRow; //Se establece el modelo de consulta de datos.
            }  
    else 
        {
            //En caso de contar con el criterio de filtrado.
            $consulta= "SELECT idUnidad, Nomenclatura, Unidad, Status FROM catUnidades WHERE Status=0 AND " .$condicionales." limit ".$Inicio.",".$DisplayRow; //Se establece el modelo de consulta de datos.
            }  
    ...
    function constructor($dataset, $sufijo)
        {        
            ...
            $objGrid = new myGrid($dataset, 'Catalogo de Unidades', $sufijo, 'idUnidad');
