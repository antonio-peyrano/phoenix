            ...
            public function drawUI()
                {
                    echo '  <html>
                                ...
                                <div id="paginado" style="display:none">
                                    ...
                                    <input id="pgobjope" type="text" value="">
                                ...
                                <center><div id= "divbusqueda">
                                    <form id="frmbusqueda" method="post" action="">
                                        <table class="queryTable" colspan= "3">
                                            <tr><td class= "queryRowsnormTR" width ="180">Por objetivo operativo: </td><td class= "queryRowsnormTR" width ="250"><input type= "text" id= "nomobjope"></td><td rowspan= "3"><img id="'.$this->sufijo.'buscar" align= "left" src= "./img/grids/view.png" width= "25" height= "25" alt="Buscar"/></td></tr>
            ...
            if($objUsrCtrl->validarCredenciales($idUsuario, $Modulo)!='')
                {
                     ...
                     * modulo solicitado.
                     */
                    $objBusObjOpe = new busObjOpe();
            
                    echo '  <html>
                                    <center>';
            
                    echo            $objBusObjOpe->drawUI();
