            ...
            if($idRegistro == -1)
                {
                    ...
                    echo '<tr class="dgHeader" style="text-align:right"><td colspan= "2"><a href="#" onclick="cargar(\'./php/frontend/vehiculos/busVehiculos.php\',\'\',\'escritorio\');"><img align= "right" src= "./img/grids/volver.png" width= "25" height= "25" alt= "Volver" id= "btnVolver"/></a><a href="#" onclick="guardarVehiculos(\'./php/backend/vehiculos/guardar.php\',\'?id=\'+document.getElementById(\'idVehiculo\').value.toString()+\'&identidad=\'+document.getElementById(\'idEntidad\').value.toString()+\'&numeconomico=\'+document.getElementById(\'NumEconomico\').value.toString()+\'&numplaca=\'+document.getElementById(\'NumPlaca\').value.toString()+\'&color=\'+document.getElementById(\'Color\').value.toString()+\'&marca=\'+document.getElementById(\'Marca\').value.toString()+\'&modelo=\'+document.getElementById(\'Modelo\').value.toString()+\'&tmotor=\'+document.getElementById(\'TMotor\').value.toString()+\'&periodo=\'+document.getElementById(\'Periodo\').value.toString()+\'&status=\'+document.getElementById(\'Status\').value.toString());"><img align= "right" src= "./img/grids/save.png" width= "25" height= "25" alt= "Guardar" id= "btnGuardar"/></a></td></tr>';
                    }
            else 
                {
                    if($cntview == 1)
                        {
                            ...
                            echo '<tr class="dgHeader" style="text-align:right"><td colspan= "2"><a href="#" onclick="cargar(\'./php/frontend/vehiculos/busVehiculos.php\',\'\',\'escritorio\');"><img align= "right" src= "./img/grids/volver.png" width= "25" height= "25" alt= "Volver" id= "btnVolver"/></a><a href="#" onclick="cargar(\'./php/backend/vehiculos/borrar.php\',\'?id=\'+document.getElementById(\'idVehiculo\').value.toString(),\'escritorio\');"><img align= "right" src= "./img/grids/erase.png" width= "25" height= "25" alt= "Borrar" id= "btnBorrar"/></a><a href="#" onclick="guardarVehiculos(\'./php/backend/vehiculos/guardar.php\',\'?id=\'+document.getElementById(\'idVehiculo\').value.toString()+\'&identidad=\'+document.getElementById(\'idEntidad\').value.toString()+\'&numeconomico=\'+document.getElementById(\'NumEconomico\').value.toString()+\'&numplaca=\'+document.getElementById(\'NumPlaca\').value.toString()+\'&color=\'+document.getElementById(\'Color\').value.toString()+\'&marca=\'+document.getElementById(\'Marca\').value.toString()+\'&modelo=\'+document.getElementById(\'Modelo\').value.toString()+\'&tmotor=\'+document.getElementById(\'TMotor\').value.toString()+\'&periodo=\'+document.getElementById(\'Periodo\').value.toString()+\'&status=\'+document.getElementById(\'Status\').value.toString());"><img align= "right" src= "./img/grids/save.png" width= "25" height= "25" alt= "Guardar" id= "btnGuardar"/></a><a href="#" onclick="habVehiculos();"><img align= "right" src= "./img/grids/edit.png" width= "25" height= "25" alt= "Editar" id= "btnEditar"/></a></td></tr>';
                            }
                    else
                        {
                            //En caso que la acciÃ³n corresponda a la ediciÃ³n de un registro.
                            echo '<tr class="dgHeader" style="text-align:right"><td colspan= "2"><a href="#" onclick="cargar(\'./php/frontend/vehiculos/busVehiculos.php\',\'\',\'escritorio\');"><img align= "right" src= "./img/grids/volver.png" width= "25" height= "25" alt= "Volver" id= "btnVolver"/><a href="#" onclick="guardarVehiculos(\'./php/backend/vehiculos/guardar.php\',\'?id=\'+document.getElementById(\'idVehiculo\').value.toString()+\'&identidad=\'+document.getElementById(\'idEntidad\').value.toString()+\'&numeconomico=\'+document.getElementById(\'NumEconomico\').value.toString()+\'&numplaca=\'+document.getElementById(\'NumPlaca\').value.toString()+\'&color=\'+document.getElementById(\'Color\').value.toString()+\'&marca=\'+document.getElementById(\'Marca\').value.toString()+\'&modelo=\'+document.getElementById(\'Modelo\').value.toString()+\'&tmotor=\'+document.getElementById(\'TMotor\').value.toString()+\'&periodo=\'+document.getElementById(\'Periodo\').value.toString()+\'&status=\'+document.getElementById(\'Status\').value.toString());"><img align= "right" src= "./img/grids/save.png" width= "25" height= "25" alt= "Guardar" id= "btnGuardar"/></a><a href="#" onclick="habVehiculos();"><img align= "right" src= "./img/grids/edit.png" width= "25" height= "25" alt= "Editar" id= "btnEditar"/></a></td></tr>';
                            }
                    }
            }
    ...
    function constructor()
        {
            ...
            echo'               <tr><td class="dgRowsaltTR" width="100px">Numero Economico:</td><td class="dgRowsnormTR"><input type= "text" required= "required" id= "NumEconomico" '.$habcampos.' value= "'.$Registro['NumEconomico'].'"></td></tr>
                                <tr><td class="dgRowsaltTR" width="100px">Numero de Placa:</td><td class="dgRowsnormTR"><input type= "text" required= "required" id= "NumPlaca" '.$habcampos.' value= "'.$Registro['NumPlaca'].'"></td></tr>
