 ...
 */
    ...
    if(isset($_GET['nomcolonia']))
        {
             ...
             */
            $condicionales= 'Colonia LIKE \'%'.$_GET['nomcolonia'].'%\'';
            }

    if(isset($_GET['cpcolonia']))
        {
            /*
             * Si el archivo ha sido llamado como una referencia con parametros.
             */
            ...
            $condicionales= $condicionales.'CodigoPostal LIKE \'%'.$_GET['cpcolonia'].'%\'';
            }

    if(isset($_GET['ciucolonia']))
        {
            /*
             * Si el archivo ha sido llamado como una referencia con parametros.
             */
            ...
            $condicionales= $condicionales.'Ciudad LIKE \'%'.$_GET['ciucolonia'].'%\'';
            }
            
    if(isset($_GET['estcolonia']))
        {
            /*
             * Si el archivo ha sido llamado como una referencia con parametros.
             */
            ...
            $condicionales= $condicionales.'Estado LIKE \'%'.$_GET['estcolonia'].'%\'';
            }
    ...
    function constructor($dataset,$sufijo)
        {        
            ...
            $objGrid = new myGrid($dataset, 'Catalogo de Colonias', $sufijo, 'idColonia');
