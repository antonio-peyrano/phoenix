    ...
    if($condicionales=="")
        {
            ...
            $consulta= "SELECT idEntidad, Entidad, TEntidad, catEntidades.Status FROM catEntidades INNER JOIN catTEntidades ON catEntidades.idTEntidad = catTEntidades.idTEntidad WHERE catEntidades.Status=0"; //Se establece el modelo de consulta de datos.
            }  
    else 
        {
            //En caso de contar con el criterio de filtrado.
            $consulta= "SELECT idEntidad, Entidad, TEntidad, catEntidades.Status FROM catEntidades INNER JOIN catTEntidades ON catEntidades.idTEntidad = catTEntidades.idTEntidad WHERE catEntidades.Status=0 AND " .$condicionales; //Se establece el modelo de consulta de datos.
            }  
