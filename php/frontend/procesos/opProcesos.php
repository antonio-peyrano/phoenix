                                ...
                                if(in_array($RegNiveles['idEntidad'], $tmparray,true))
                                    {
                                         ...
                                         */
                                        echo '<input type="checkbox" class="check" id="idEntidad[]" name="idEntidad[]" '.$habcampos.' value='.$RegNiveles['idEntidad'].' checked>'.$RegNiveles['Entidad'];
                                        }
                                else
                                    {
                                        /*
                    ...
                    if($cntview == 1)
                        {
                            ...
                            echo '<tr class="dgHeader" style="text-align:right"><td colspan= "2"><a href="#" onclick="cargar(\'./php/frontend/procesos/busProcesos.php\',\'\',\'escritorio\');"><img align= "right" src= "./img/grids/volver.png" width= "25" height= "25" alt= "Volver" id= "btnVolver"/></a><a href="#" onclick="cargar(\'./php/backend/procesos/borrar.php\',\'?id=\'+document.getElementById(\'idProceso\').value.toString(),\'escritorio\');"><img align= "right" src= "./img/grids/erase.png" width= "25" height= "25" alt= "Borrar" id= "btnBorrar"/></a><a href="#" onclick="guardarProceso(\'./php/backend/procesos/guardar.php\',\'?id=\'+document.getElementById(\'idProceso\').value.toString()+\'&proceso=\'+document.getElementById(\'Proceso\').value.toString()+\'&identidad=\'+vectorizacion()+\'&nonidentidad=\'+nonvectorizacion()+\'&status=\'+document.getElementById(\'Status\').value.toString());"><img align= "right" src= "./img/grids/save.png" width= "25" height= "25" alt= "Guardar" id= "btnGuardar"/></a><a href="#" onclick="habProceso();"><img align= "right" src= "./img/grids/edit.png" width= "25" height= "25" alt= "Editar" id= "btnEditar"/></a></td></tr>';
                            }
                    else
                        {
            ...
            echo'
                    <html>
                        ...
                        <body>
                            ...
                            <center>
                            <div id="infoProceso" style="width: 400px; height: 600px;">                                  
                            <table class="dgTable">
                                <tr><th class="dgHeader" colspan= 2">Procesos en el Sistema</th></tr>
                                <tr><td class="dgRowsaltTR" width="100px">Proceso:</td><td class="dgRowsnormTR"><input type= "text" required= "required" id= "Proceso" '.$habcampos.' value= "'.$Registro['Proceso'].'"></td></tr>';
