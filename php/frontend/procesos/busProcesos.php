            ...
            public function drawUI()
                {
                    echo '  <html>
                                ...
                                <div id="paginado" style="display:none">
                                    ...
                                    <input id="pgproceso" type="text" value="">
                                ...
                                <center><div id= "divbusqueda">
                                    <form id="frmbusqueda" method="post" action="">
                                        <table class="queryTable" colspan= "7">
                                            <tr><td class= "queryRowsnormTR" width ="180">Por proceso: </td><td class= "queryRowsnormTR" width ="250"><input type= "text" id= "nomproceso"></td><td rowspan= "2"><img id="'.$this->sufijo.'buscar" align= "left" src= "./img/grids/view.png" width= "25" height= "25" alt="Buscar"/></td></tr>
            ...
            if($objUsrCtrl->validarCredenciales($idUsuario, $Modulo)!='')
                {
                     ...
                     * modulo solicitado.
                     */
                    $objBusProcesos = new busProcesos();
        
                    echo '  <html>
                                    <center>';
        
                    echo                $objBusProcesos->drawUI();
        
                    echo '          </center><br>';
        
                    echo '          <div id= "busRes">';
                                        include_once("catProcesos.php");
                    echo '          </div>
                            </html>';
                    }
            else
