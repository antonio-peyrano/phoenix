    ...
    if($condicionales=="")
        {
            ...
            $consulta= 'SELECT idUsrtmp, Nivel, Usuario, Clave, Correo, opUsrTemp.Status FROM opUsrTemp INNER JOIN catNiveles ON catNiveles.idNivel = opUsrTemp.idNivel WHERE opUsrTemp.Status=0'; //Se establece el modelo de consulta de datos.
            }  
    else 
        {
            //En caso de contar con el criterio de filtrado.
            $consulta= 'SELECT idUsrtmp, Nivel, Usuario, Clave, Correo, opUsrTemp.Status FROM opUsrTemp INNER JOIN catNiveles ON catNiveles.idNivel = opUsrTemp.idNivel WHERE opUsrTemp.Status=0 AND ' .$condicionales; //Se establece el modelo de consulta de datos.
            }  
