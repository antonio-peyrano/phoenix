 ...
 */
    ...
    function cargarColor($parametro)
        {
            ...
            $consulta= 'SELECT Marca FROM catVehiculos WHERE Status=0 AND idVehiculo='.$parametro; //Se establece el modelo de consulta de datos.
    ...
    echo '  <input style="width:300px;" class="inputform" type= "text" required= "required" id= "Marca" '.$habcampos.' value= "'.$RegNiveles['Marca'].'">';    
?>