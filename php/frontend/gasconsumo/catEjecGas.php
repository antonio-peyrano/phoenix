    ...
    if($condicionales == "")
        {
            ...
            $consulta= "SELECT idMovGas, Cantidad, Mes, Status FROM opMovGas WHERE Status=0"." limit ".$Inicio.",".$DisplayRow; //Se establece el modelo de consulta de datos.
            }  
    else 
        {
            //En caso de contar con el criterio de filtrado.
            $consulta= "SELECT idMovGas, Cantidad, Mes, Status FROM opMovGas WHERE Status=0 AND " .$condicionales." limit ".$Inicio.",".$DisplayRow; //Se establece el modelo de consulta de datos.
            }  
