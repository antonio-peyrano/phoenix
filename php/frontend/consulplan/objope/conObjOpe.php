 ...
 */
    ...
    function loadInfo($idRegistro, $titulo)        
        {
             ...
             */
              ...
              */
             $objConexion= new mySQL_conexion($username, $password, $servername, $dbname); //Se crea el objeto de la clase a instanciar.
             $consulta= "SELECT Nomenclatura, ObjEst AS Objetivo, Periodo FROM catObjEst WHERE Status=0 AND idObjEst=".$idRegistro; //Se establece el modelo de consulta de datos.
            ...
            /*
             * Obteniendo la informacion asociada de la ejecución en planeacion.
             */
            $objConexion= new mySQL_conexion($username, $password, $servername, $dbname); //Se crea el objeto de la clase a instanciar.
    ...
    function constructor($dataset)
        {        
             ...
             */
            global $idObjEst, $sufijo, $Periodo;
            ...
            echo'       <center>'; 
                        ...
                        loadInfo($idObjEst, 'Informacion del Objetivo Estrategico');
                        
                        $_GET['periodo'] = $Periodo;
                        
            echo '<div id="divLstObjOpe">';                        
                        include_once($_SERVER['DOCUMENT_ROOT']."/phoenix/php/frontend/consulplan/objope/lstObjOpe.php");
            echo '</div>';
            ...
            echo'       <center>';
                    echo'
                                ...
                                <div id="pie" class="pie-operativo">
                                    <tr><td><a href="#" onclick="cargar(\'./php/frontend/consulplan/objest/conObjEst.php\',\'?idobjest='.$idObjEst.'\',\'sandbox\');"><img align= "right" src= "./img/grids/volver.png" width= "25" height= "25" alt= "Volver" id= "btnVolver"/></a></td></tr>
                                </div>
                            </div>
                        </body>
                    </html>';
