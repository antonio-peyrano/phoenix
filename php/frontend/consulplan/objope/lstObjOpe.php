 ...
 */
    ...
    if($condicionales=="")
        {
            ...
            $consulta= "SELECT idObjOpe, Nomenclatura, ObjOpe AS Objetivo, Periodo, Status FROM catObjOpe WHERE Status=0 AND Periodo=".$Periodo." limit ".$Inicio.",".$DisplayRow; //Se establece el modelo de consulta de datos.
            }  
    else 
        {
            //En caso de contar con el criterio de filtrado.
            $consulta= "SELECT idObjOpe, Nomenclatura, ObjOpe AS Objetivo, Periodo, Status FROM catObjOpe WHERE Status=0 AND " .$condicionales. " AND Periodo=".$Periodo." limit ".$Inicio.",".$DisplayRow; //Se establece el modelo de consulta de datos.
            }  
    ...
    function lstconstructor($dataset)
        {        
             ...
             */
            global $idObjEst, $sufijo;
            
            $objGrid = new myGrid($dataset, 'Objetivos Operativos', $sufijo, 'idObjOpe', false);
