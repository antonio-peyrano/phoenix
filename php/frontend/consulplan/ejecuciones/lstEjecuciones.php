 ...
 */
    ...
    if($condicionales == "")
        {
            ...
            $consulta= "SELECT idEjecucion, Cantidad, Mes, Monto, Periodo, Status  FROM opEjecuciones WHERE Status=0 ORDER BY idEjecucion"." limit ".$Inicio.",".$DisplayRow; //Se establece el modelo de consulta de datos.
            }  
    else 
        {
            //En caso de contar con el criterio de filtrado.
            $consulta= "SELECT idEjecucion, Cantidad, Mes, Monto, Periodo, Status  FROM opEjecuciones WHERE Status=0 AND " .$condicionales. " ORDER BY idEjecucion"." limit ".$Inicio.",".$DisplayRow; //Se establece el modelo de consulta de datos.
            }       
    ...
    function lstconstructor($dataset)
        {        
            ...
            $objGrid = new myGrid($dataset, 'Ejecuciones', $sufijo, 'idEjecucion', false);
