 ...
 */
    ...
    function loadInfo($idRegistro, $titulo)        
        {
             ...
             */
              ...
              */
             $objConexion= new mySQL_conexion($username, $password, $servername, $dbname); //Se crea el objeto de la clase a instanciar.
             $consulta= "SELECT Nomenclatura, EstOpe AS Objetivo, Periodo FROM catEstOpe WHERE Status=0 AND idEstOpe=".$idRegistro; //Se establece el modelo de consulta de datos.
             ...
             if($Registro)
                {
                    ...
                    echo'<div id="infoRegistro" class="operativo" style="top:60%; left:50%;">
    ...
    function constructor($dataset)
        {        
             ...
             */
            global $idObjEst, $idObjOpe, $idEstOpe, $Periodo;
            ...
            echo'       <center>';
                        ...
                        loadInfo($idEstOpe,'Informacion de la Estrategia Operativa');
                        $_GET['periodo'] = $Periodo;
                        
            echo '<div id="divLstProgramas">';                        
                    include_once($_SERVER['DOCUMENT_ROOT']."/phoenix/php/frontend/consulplan/programas/lstProgramas.php");
            echo '</div>';
            ...
            echo'
                                ...
                                <div id="pie" class="pie-operativo">
                                    <tr><td alignt= "left" colspan= 2"><a href="#" onclick="cargar(\'./php/frontend/consulplan/estope/conEstOpe.php\',\'?idobjope='.$idObjOpe.'&idobjest='.$idObjEst.'\',\'sandbox\');"><img align= "right" src= "./img/grids/volver.png" width= "25" height= "25" alt= "Volver" id= "btnVolver"/></a></td></tr>
                                </div>
                            </div>
                        </body>
                    </html>';
