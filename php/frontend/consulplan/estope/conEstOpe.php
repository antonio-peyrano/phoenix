    ...
    function loadInfo($idRegistro, $titulo)        
        {
             ...
             */
              ...
              */
             $objConexion= new mySQL_conexion($username, $password, $servername, $dbname); //Se crea el objeto de la clase a instanciar.
             $consulta= "SELECT Nomenclatura, ObjOpe AS Objetivo, Periodo FROM catObjOpe WHERE Status=0 AND idObjOpe=".$idRegistro; //Se establece el modelo de consulta de datos.
...
function constructor($dataset)
    {        
         ...
         */
        global $idObjEst, $idObjOpe, $sufijo, $Periodo;
        ...
        echo'
            ...
            echo'       <center>'; 
                    ...
                    loadInfo($idObjOpe,'Informacion del Objetivo Operativo');
                    $_GET['periodo'] = $Periodo;
                        
        echo '<div id="divLstEstOpe">';                        
                    include_once($_SERVER['DOCUMENT_ROOT']."/phoenix/php/frontend/consulplan/estope/lstEstOpe.php");
        echo '</div>';
        ...
        echo'
                                ...
                                <div id="pie" class="pie-operativo">
                                    <tr class= "dgHeader"><td alignt= "left" colspan= 2"><a href="#" onclick="cargar(\'./php/frontend/consulplan/objope/conObjOpe.php\',\'?idobjest='.$idObjEst.'\',\'sandbox\');"><img align= "right" src= "./img/grids/volver.png" width= "25" height= "25" alt= "Volver" id= "btnVolver"/></a></td></tr>
                                </div>
                            </div>
                        </body>
                    </html>';
