 ...
 */
    ...
    if($condicionales=="")
        {
            ...
            $consulta= "SELECT idEstOpe, Nomenclatura, EstOpe AS Estrategia, Periodo, Status FROM catEstOpe WHERE Status=0 AND Periodo=".$Periodo." limit ".$Inicio.",".$DisplayRow; //Se establece el modelo de consulta de datos.
            }  
    else 
        {
            //En caso de contar con el criterio de filtrado.
            $consulta= "SELECT idEstOpe, Nomenclatura, EstOpe AS Estrategia, Periodo, Status FROM catEstOpe WHERE Status=0 AND " .$condicionales. " AND Periodo=".$Periodo." limit ".$Inicio.",".$DisplayRow; //Se establece el modelo de consulta de datos.
            }                 
    ...
    function lstconstructor($dataset)
        {        
            ...
            $objGrid = new myGrid($dataset, 'Estrategias Operativas', $sufijo, 'idEstOpe', false);
