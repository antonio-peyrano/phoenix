            ...
            public function drawUI()
                {
                    echo '  <html>
                                ...
                                <div id="paginado" style="display:none">
                                    ...
                                    <input id="pgprograma" type="text" value="">
                                ...
                                <center><div id= "divbusqueda">
                                    <form id="frmbusqueda" method="post" action="">
                                        <table class="queryTable" colspan= "7">
                                            <tr><td class= "queryRowsnormTR" width ="180">Por programa: </td><td class= "queryRowsnormTR" width ="250"><input type= "text" id= "nomprograma"></td><td rowspan= "2"><img id="'.$this->sufijo.'buscar" align= "left" src= "./img/grids/view.png" width= "25" height= "25" alt="Buscar"/></td></tr>
            ...
            if($objUsrCtrl->validarCredenciales($idUsuario, $Modulo)!='')
                {
                     ...
                     * modulo solicitado.
                     */
                    $objBusPrograma = new busPrograma();
            
                    echo '  <html>
                                    <center>';
            
                    echo            $objBusPrograma->drawUI();
            
                    echo '          </center><br>';
            
                    echo '          <div id= "busRes">';
                                        include_once("catPrograma.php");
                    echo '          </div>
                            </html>';
                    }
            else
