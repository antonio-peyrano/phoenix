                                ...
                                <center><div id= "divbusqueda">
                                    <form id="frmbusqueda" method="post" action="">
                                        <table class="queryTable" colspan= "7">
                                            <tr><td class= "queryRowsnormTR">Por periodo: </td><td class= "queryRowsnormTR"><input type= "text" id= "gasperiodo"></td><td rowspan= "2"><img id="'.$this->sufijo.'buscar" align= "left" src= "./img/grids/view.png" width= "25" height= "25" alt="Buscar"/></td></tr>
            ...
            if($objUsrCtrl->validarCredenciales($idUsuario, $Modulo)!='')
                {
                     ...
                     * modulo solicitado.
                     */
                    $objBusGasolina = new busGasolina();
        
                    echo '  <html>
                                    <center>';
        
                    echo                $objBusGasolina->drawUI();
