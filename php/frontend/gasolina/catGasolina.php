    ...
    if($condicionales=="")
        {
            ...
            $consulta= "SELECT idProgGas, opProgGas.idEntidad, Entidad, opProgGas.Status FROM (opProgGas INNER JOIN catEntidades ON catEntidades.idEntidad = opProgGas.idEntidad) WHERE opProgGas.Status=0 ORDER BY idEntidad"; //Se establece el modelo de consulta de datos.
            }  
    else 
        {
            //En caso de contar con el criterio de filtrado.
            $consulta= "SELECT idProgGas, opProgGas.idEntidad, Entidad, opProgGas.Status FROM (opProgGas INNER JOIN catEntidades ON catEntidades.idEntidad = opProgGas.idEntidad) WHERE opProgGas.Status=0 AND " .$condicionales. " ORDER BY idEntidad"; //Se establece el modelo de consulta de datos.
            }  
