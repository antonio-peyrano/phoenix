                    ...
                    if($cntview == 1)
                        {
                            ...
                            echo '<tr class="dgHeader" style="text-align:right"><td colspan= "2"><a href="#" onclick="cargar(\'./php/frontend/estope/busEstOpe.php\',\'\',\'escritorio\');"><img align= "right" src= "./img/grids/volver.png" width= "25" height= "25" alt= "Volver" id= "btnVolver"/></a><a href="#" onclick="cargar(\'./php/backend/estope/borrar.php\',\'?id=\'+document.getElementById(\'idObjOpe\').value.toString(),\'escritorio\');"><img align= "right" src= "./img/grids/erase.png" width= "25" height= "25" alt= "Borrar" id= "btnBorrar"/></a><a href="#" onclick="guardarEstOpe(\'./php/backend/estope/guardar.php\',\'?id=\'+document.getElementById(\'idEstOpe\').value.toString()+\'&idobjest=\'+document.getElementById(\'idObjEst\').value.toString()+\'&idobjope=\'+document.getElementById(\'idObjOpe\').value.toString()+\'&nomenclatura=\'+document.getElementById(\'Nomenclatura\').value.toString()+\'&estope=\'+document.getElementById(\'EstOpe\').value.toString()+\'&periodo=\'+document.getElementById(\'Periodo\').value.toString()+\'&status=\'+document.getElementById(\'Status\').value.toString());"><img align= "right" src= "./img/grids/save.png" width= "25" height= "25" alt= "Guardar" id= "btnGuardar"/></a><a href="#" onclick="habEstOpe();"><img align= "right" src= "./img/grids/edit.png" width= "25" height= "25" alt= "Editar" id= "btnEditar"/></a></td></tr>';
                            }
                    else
                        {
    ...
    function constructor()
        {
            ...
            echo'
                    <html>
                        ...
                        <body>
                            ...
                            <center>
                            <div id="infoEstOpe" style="width: 400px; height: 600px;">                                
                            <table class="dgTable">
                                <tr><th class="dgHeader" colspan= 2">Estrategia Operativa en el Sistema</th></tr>';
            ...
            echo'               <tr><td class="dgRowsaltTR" width="100px">Estrategia Operativa:</td><td class="dgRowsnormTR"><input type= "text" required= "required" id= "EstOpe" '.$habcampos.' value= "'.$Registro['EstOpe'].'"></td></tr>';
