 ...
 */
    ...
    $imgTitleURL = './img/menu/cedula.png';
    $Title = 'Cedulas';
    $parametro = $_GET['id'];
    $cntview = $_GET['view'];
                    ...
                    <html>
                        ...
                        <body>
                            ...
                            <div style=display:none>
                                ...
                                <tr><td class="td-panel" width="100px">Horizonte:</td><td><input type= "text" required= "required" id= "Horizonte" '.$habcampos.' value= "'.$Registro['Horizonte'].'"></td></tr>';
