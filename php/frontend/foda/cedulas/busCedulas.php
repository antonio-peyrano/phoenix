    ...
    class busCedulas
        {
            ...
            public function drawUI()
                {
                    echo '      <link rel= "stylesheet" href= "./css/queryStyle.css"></style>
                                ...
                                <center><div id= "divbusqueda">
                                    ...
                                    <tr><td class= "queryRowsnormTR" width ="180">Por folio: </td><td class= "queryRowsnormTR" width ="250"><input type= "text" id= "fcefolio"></td><td rowspan= "2"><img id="'.$this->sufijo.'buscar" align= "left" src= "./img/grids/view.png" width= "25" height= "25" alt="Buscar"/></td></tr>
                                    <tr><td class= "queryRowsnormTR">Por fecha: </td><td class= "queryRowsnormTR"><input type= "text" id= "fcefecha"></td></tr>
