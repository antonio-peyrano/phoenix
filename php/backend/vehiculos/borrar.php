 ...
 */
    ...
    $consulta= 'UPDATE catVehiculos SET Status=1 where idVehiculo='.$parametro; //Se establece el modelo de consulta de datos.
    $dataset = $objConexion -> conectar($consulta); //Se ejecuta la consulta. 
       
    include_once($_SERVER['DOCUMENT_ROOT']."/phoenix/php/frontend/vehiculos/busVehiculos.php");
    ?>