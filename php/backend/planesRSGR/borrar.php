 ...
 */
    ...
    $consulta= 'UPDATE opPlanesRSGR SET Status=1 where idPlanRSGR='.$parametro; //Se establece el modelo de consulta de datos.
    $dataset = $objConexion -> conectar($consulta); //Se ejecuta la consulta.
    
    $consulta= 'UPDATE relProRSGR SET Status=1 where idPlanRSGR='.$parametro; //Se establece el modelo de consulta de datos.
    $dataset = $objConexion -> conectar($consulta); //Se ejecuta la consulta.
