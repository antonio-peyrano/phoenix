 ...
 */
    ...
    $consulta= 'UPDATE opProgramas SET Status=1 where idPrograma='.$parametro; //Se establece el modelo de consulta de datos.
    $dataset = $objConexion -> conectar($consulta); //Se ejecuta la consulta.
    
    $consulta= 'UPDATE relProgPro SET Status=1 where idPrograma='.$parametro; //Se establece el modelo de consulta de datos.
    $dataset = $objConexion -> conectar($consulta); //Se ejecuta la consulta.
