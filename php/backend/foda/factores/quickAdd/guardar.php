 ...
 */
    ...
    if(isset($_GET['id'])&&isset($_GET['factor'])&&isset($_GET['tipo'])&&isset($_GET['idcedula'])&&isset($_GET['status']))
        {
            /*
            ...
            if($idFactor != null)
                {
                     ...
                     */
                    $consulta = 'UPDATE opFactores SET Factor=\''.$Factor.'\', Tipo=\''.$Tipo.'\', idCedula=\''.$idCedula.'\', Status=\''.$Status.'\' WHERE idFactor='.$idFactor; //Se establece el modelo de consulta de datos.
                    }
            else
                {
                    /*
                     ...
                     */
                    $consulta = 'INSERT INTO opFactores (Factor, idCedula, Tipo) VALUES ('.'\''.$Factor.'\',\''.$idCedula.'\',\''.$Tipo.'\')'; //Se establece el modelo de consulta de datos.
                    }
            
            $dataset = $objConexion -> conectar($consulta); //Se ejecuta la consulta.
            include_once($_SERVER['DOCUMENT_ROOT']."/micrositio/php/frontend/foda/factores/opQuickFactores.php");
            }
    else
        {
            /*
