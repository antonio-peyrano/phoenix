 ...
 */
    ...
    if(isset($_GET['id'])&&isset($_GET['colonia'])&&isset($_GET['cp'])&&isset($_GET['ciudad'])&&isset($_GET['estado'])&&isset($_GET['status']))
        {
            /*
            ...
            if($idColonia != null)
                {
                     ...
                     */
                    $consulta = 'UPDATE catColonias SET Colonia=\''.$Colonia.'\', CodigoPostal=\''.$CP.'\', Ciudad=\''.$Ciudad.'\', Estado=\''.$Estado.'\', Status=\''.$Status.'\' WHERE idColonia='.$idColonia; //Se establece el modelo de consulta de datos.
                    }
            else
                {
                    /*
                     ...
                     */
                    $consulta = 'INSERT INTO catColonias (Colonia, CodigoPostal, Ciudad, Estado) VALUES ('.'\''.$Colonia.'\',\''.$CP.'\', \''.$Ciudad.'\', \''.$Estado.'\')'; //Se establece el modelo de consulta de datos.
                    }
            
            $dataset = $objConexion -> conectar($consulta); //Se ejecuta la consulta.    
            include_once($_SERVER['DOCUMENT_ROOT']."/micrositio/php/frontend/colonias/busColonias.php");
            }
    else
        {
            /*
